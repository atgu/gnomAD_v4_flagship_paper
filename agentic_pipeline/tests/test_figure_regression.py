#!/usr/bin/env python3
"""T5 — figure regression: regenerate Figure 6 and compare it to the reference.
...
directory and requires the assembled PNG to match byte for byte.
    ...
    python3 test_figure_regression.py [--workdir DIR]
"""
...
def main() -> None:
    ...
    c = Checks("T5 — figure regression, _new variant")
